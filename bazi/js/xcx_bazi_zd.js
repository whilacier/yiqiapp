...
var bmf = {'鼠':'千手观音菩萨', '牛':'虚空藏菩萨', '虎':'虚空藏菩萨', '兔':'文殊菩萨', '龙':'普贤菩萨', '蛇':'普贤菩萨', '马':'大势至菩萨', '羊':'大日如来', '猴':'大日如来', '鸡':'不动尊菩萨', '狗':'阿弥陀佛', '猪':'阿弥陀佛', 	 };     	   	
	  

	var bztg = {'甲':'<span style="color:#228B22;font-weight:900;font-size:26.87px;">甲</span><span style="color:#228B22;font-weight:900;">木</span>', '乙':'<span style="color:#228B22;font-weight:900;font-size:26.87px;">乙</span><span style="color:#228B22;font-weight:900;">木</span>', 
				'丙':'<span style="color:#FF0000;font-weight:900;font-size:26.87px;">丙</span><span style="color:#FF0000;font-weight:900;">火</span>', '丁':'<span style="color:#FF0000;font-weight:900;font-size:26.87px;">丁</span><span style="color:#FF0000;font-weight:900;">火</span>', 
				'戊':'<span style="color:#715a15;font-weight:900;font-size:26.87px;">戊</span><span style="color:#715a15;font-weight:900;">土</span>', '己':'<span style="color:#715a15;font-weight:900;font-size:26.87px;">己</span><span style="color:#715a15;font-weight:900;">土</span>', 
				'庚':'<span style="color:#ef9113;font-weight:900;font-size:26.87px;">庚</span><span style="color:#ef9113;font-weight:900;">金</span>', '辛':'<span style="color:#ef9113;font-weight:900;font-size:26.87px;">辛</span><span style="color:#ef9113;font-weight:900;">金</span>', 
				'壬':'<span style="color:#185fac;font-weight:900;font-size:26.87px;">壬</span><span style="color:#185fac;font-weight:900;">水</span>', '癸':'<span style="color:#185fac;font-weight:900;font-size:26.87px;">癸</span><span style="color:#185fac;font-weight:900;">水</span>'		      };

	var bzdz = {'子':'<span style="color:#185fac;font-weight:900;font-size:26.87px;">子</span><span style="color:#185fac;font-weight:900;">水</span>', '丑':'<span style="color:#715a15;font-weight:900;font-size:26.87px;">丑</span><span style="color:#715a15;font-weight:900;">土</span>', 
				'寅':'<span style="color:#228B22;font-weight:900;font-size:26.87px;">寅</span><span style="color:#228B22;font-weight:900;">木</span>', '卯':'<span style="color:#228B22;font-weight:900;font-size:26.87px;">卯</span><span style="color:#228B22;font-weight:900;">木</span>', 
				'辰':'<span style="color:#715a15;font-weight:900;font-size:26.87px;">辰</span><span style="color:#715a15;font-weight:900;">土</span>', '巳':'<span style="color:#FF0000;font-weight:900;font-size:26.87px;">巳</span><span style="color:#FF0000;font-weight:900;">火</span>', 
				'午':'<span style="color:#FF0000;font-weight:900;font-size:26.87px;">午</span><span style="color:#FF0000;font-weight:900;">火</span>', '未':'<span style="color:#715a15;font-weight:900;font-size:26.87px;">未</span><span style="color:#715a15;font-weight:900;">土</span>', 
				'申':'<span style="color:#ef9113;font-weight:900;font-size:26.87px;">申</span><span style="color:#ef9113;font-weight:900;">金</span>', '酉':'<span style="color:#ef9113;font-weight:900;font-size:26.87px;">酉</span><span style="color:#ef9113;font-weight:900;">金</span>', 
				'戌':'<span style="color:#715a15;font-weight:900;font-size:26.87px;">戌</span><span style="color:#715a15;font-weight:900;">土</span>', '亥':'<span style="color:#185fac;font-weight:900;font-size:26.87px;">亥</span><span style="color:#185fac;font-weight:900;">水</span>'		      };


	var bztgbeifen = {'甲':'<span style="color:#228B22;font-weight:900;">甲木</span>', '乙':'<span style="color:#228B22;font-weight:900;">乙木</span>', 
				'丙':'<span style="color:#FF0000;font-weight:900;">丙火</span>', '丁':'<span style="color:#FF0000;font-weight:900;">丁火</span>', 
				'戊':'<span style="color:#715a15;font-weight:900;">戊土</span>', '己':'<span style="color:#715a15;font-weight:900;">己土</span>', 
				'庚':'<span style="color:#ef9113;font-weight:900;">庚金</span>', '辛':'<span style="color:#ef9113;font-weight:900;">辛金</span>', 
				'壬':'<span style="color:#185fac;font-weight:900;">壬水</span>', '癸':'<span style="color:#185fac;font-weight:900;">癸水</span>'		      };

	var bzdzbeifen = {'子':'<span style="color:#185fac;font-weight:900;">子水</span>', '丑':'<span style="color:#715a15;font-weight:900;">丑土</span>', 
				'寅':'<span style="color:#228B22;font-weight:900;">寅木</span>', '卯':'<span style="color:#228B22;font-weight:900;">卯木</span>', 
				'辰':'<span style="color:#715a15;font-weight:900;">辰土</span>', '巳':'<span style="color:#FF0000;font-weight:900;">巳火</span>', 
				'午':'<span style="color:#FF0000;font-weight:900;">午火</span>', '未':'<span style="color:#715a15;font-weight:900;">未土</span>', 
				'申':'<span style="color:#ef9113;font-weight:900;">申金</span>', '酉':'<span style="color:#ef9113;font-weight:900;">酉金</span>', 
				'戌':'<span style="color:#715a15;font-weight:900;">戌土</span>', '亥':'<span style="color:#185fac;font-weight:900;">亥水</span>'		      };
	...
	var bzdzbeifen = {'子':'<span style="color:#185fac;font-weight:900;">子水</span>', '丑':'<span style="color:#715a15;font-weight:900;">丑土</span>', 
      ...
      s += '<td colspan="8" class="td2">'+solar.getYear()+'年'+solar.getMonth()+'月'+solar.getDay()+'日'+solar.getHour()+'时'+solar.getMinute()+'分</td>';
      s += '</tr>';
      s += '<tr>';
	...
	s += '</tr>';
      ...
      //s += '</tr>';
      s += '<tr>';
      s += '<th class="th1" valign="top">四柱<br><div style="font-size:11px;color:#FF9999;line-height:13px;">点击查看象意</div></th>';
      s += '<td colspan="2" style="line-height:27px;" class="td1" id="tgxynian">'+bztg[lunar.getYearGanExact()]+'<br>'+bzdz[lunar.getYearZhiExact()]+'</td>';
      s += '<td colspan="2" style="line-height:27px;" class="td1" id="tgxyyue">'+bztg[lunar.getMonthGanExact()]+'<br>'+bzdz[lunar.getMonthZhiExact()]+'</td>';
      s += '<td colspan="2" style="line-height:27px;" class="td1" id="tgxyri">'+bztg[bazi.getDayGan()]+'<br>'+bzdz[bazi.getDayZhi()]+'</td>';
      s += '<td colspan="2" style="line-height:27px;" class="td1" id="tgxyshi">'+bztg[bazi.getTimeGan()]+'<br>'+bzdz[bazi.getTimeZhi()]+'</td>';
      s += '</tr>';
      s += '<tr>';
  ...
  function getChangSheng(gan, ganIndex, zhiIndex){
    ...
    s += '</tr>';
	  ...
	  //四柱天干顺序同时出现
	  var shenShaGanGan = {     
	    '<span id="天三奇">天三奇</span>' :['甲戊庚', '庚戊甲'],
	    '<span id="地三奇">地三奇</span>' :['乙丙丁', '丁丙乙'],	  
	    '<span id="人三奇">人三奇</span>' :['壬癸辛', '辛癸壬']	 
	  };
	  
	  //四柱地支顺序同时出现
	  var shenShaZhiZhi = {
	    '<span id="三台">三台</span>' :['寅辰申', '卯巳午', '亥子酉'] 
	  };
	     
	  // 年日天干查地支
	  var shenShaYearDayGanZhi = {
	    '<span id="天乙">天乙</span>' : ['甲丑', '甲未', '乙子', '乙申', '丙亥', '丙酉', '丁亥', '丁酉', '戊丑', '戊未', '己子', '己申', '庚午', '庚寅', '庚丑', '庚未', '辛午', '辛寅', '壬卯', '壬巳', '癸卯', '癸巳'],
	    '<span id="太极">太极</span>' : ['甲子', '甲午', '乙子', '乙午', '丙卯', '丙酉', '丁卯', '丁酉', '戊辰', '戊戌', '戊丑', '戊未', '己辰', '己戌', '己丑', '己未', '庚亥', '庚寅', '辛亥', '辛寅', '壬申', '壬巳', '癸申', '癸巳'],
	    '<span id="天印">天印</span>' : ['甲寅', '乙亥', '丙戌', '丁酉', '戊申', '己未', '庚午', '辛巳', '壬辰', '癸卯'],
	    '<span id="天厨">天厨</span>' : ['甲巳', '乙午', '丙巳', '丁午', '戊申', '己酉', '庚亥', '辛子', '壬寅', '癸卯'],
	    '<span id="天官">天官</span>' : ['甲未', '乙辰', '丙巳', '丁酉', '丁寅', '戊戌', '戊丑', '己卯', '己戌', '庚丑', '庚亥', '辛申', '壬寅', '壬酉', '癸午'],	  
	    '<span id="文昌">文昌</span>' : ['甲巳', '乙午', '丙申', '丁酉', '戊申', '己酉', '庚亥', '辛子', '壬寅', '癸卯'],
	    '<span id="国印">国印</span>' : ['甲戌', '甲亥', '甲酉', '乙亥', '乙子', '乙戌', '丙丑', '丙子', '丙寅', '丁寅', '丁丑', '丁卯', '戊丑', '戊子', '戊寅', '己寅', '己丑', '己卯', '庚辰', '庚卯', '庚巳', '辛巳', '辛辰', '辛午', '壬未', '壬午', '壬申', '癸申', '癸未', '癸酉'],
	    '<span id="福星">福星</span>' : ['甲寅', '甲子', '乙卯', '乙丑', '丙寅', '丙子', '丁亥', '丁酉', '戊申', '己未', '庚午', '辛巳', '壬辰', '癸卯', '癸丑'],
	    '<span id="金舆">金舆</span>' : ['甲辰', '乙巳', '丙未', '丁申', '戊未', '己申', '庚戌', '辛亥', '壬丑', '癸寅'],
	    //'<span id="穷煞">穷煞</span>' : ['甲巳', '乙寅', '丙子', '丁戌', '戊申', '己午', '庚卯', '辛丑', '壬亥', '癸酉'],
	    '<span id="破祖">破祖</span>' : ['甲午', '乙午', '丙申', '丁申', '戊戌', '己戌', '庚子', '辛子', '壬寅', '癸寅']
	  };
	  
	  // 年日天干查干支
	  var shenShaYearGanDayGanGanZhi = {    
	     '<span id="学堂">学堂</span>' : ['甲己亥', '乙壬午', '丙丙寅', '丁丁酉', '戊戊申', '己己酉', '庚辛巳', '辛甲子', '壬甲申', '癸乙卯'], 
	     '<span id="词馆">词馆</span>' : ['甲庚寅', '乙辛卯', '丙乙巳', '丁戊午', '戊丁巳', '己庚午', '庚壬申', '辛癸酉', '壬癸亥', '癸壬戌']
	  };
	   
	  //年柱纳音查地支
	  var shenShaYearNaYinDiZhi = {     
	    '<span id="学堂纳音">学堂</span>' : ['海中金巳', '剑锋金巳', '白蜡金巳', '沙中金巳', '金箔金巳', '钗钏金巳', '大林木亥', '杨柳木亥', '松柏木亥', '平地木亥', '桑柘木亥', '石榴木亥', '涧下水申', '泉中水申', '长流水申', '天河水申', '大溪水申', '大海水申', '霹雳火寅', '山下火寅', '覆灯火寅', '炉中火寅', '山头火寅', '天上火寅', '壁上土申', '大驿土申', '沙中土申', '路旁土申', '城头土申', '屋上土申'],
	    '<span id="词馆纳音">词馆</span>' : ['海中金申', '剑锋金申', '白蜡金申', '沙中金申', '金箔金申', '钗钏金申', '大林木寅', '杨柳木寅', '松柏木寅', '平地木寅', '桑柘木寅', '石榴木寅', '涧下水亥', '泉中水亥', '长流水亥', '天河水亥', '大溪水亥', '大海水亥', '霹雳火巳', '山下火巳', '覆灯火巳', '炉中火巳', '山头火巳', '天上火巳', '壁上土亥', '大驿土亥', '沙中土亥', '路旁土亥', '城头土亥', '屋上土亥']
	  };
	   
	  //年柱纳音查干支
	  var shenShaYearNaYinGanZhi = {     
	    //'<span id="正学堂">正学堂</span>' : ['海中金辛巳', '剑锋金辛巳', '白蜡金辛巳', '沙中金辛巳', '金箔金辛巳', '钗钏金辛巳', '大林木己亥', '杨柳木己亥', '松柏木己亥', '平地木己亥', '桑柘木己亥', '石榴木己亥', '涧下水甲申', '泉中水甲申', '长流水甲申', '天河水甲申', '大溪水甲申', '大海水甲申', '霹雳火丙寅', '山下火丙寅', '覆灯火丙寅', '炉中火丙寅', '山头火丙寅', '天上火丙寅', '壁上土戊申', '大驿土戊申', '沙中土戊申', '路旁土戊申', '城头土戊申', '屋上土戊申'],
	    //'<span id="正词馆">正词馆</span>' : ['海中金壬申', '剑锋金壬申', '白蜡金壬申', '沙中金壬申', '金箔金壬申', '钗钏金壬申', '大林木庚寅', '杨柳木庚寅', '松柏木庚寅', '平地木庚寅', '桑柘木庚寅', '石榴木庚寅', '涧下水癸亥', '泉中水癸亥', '长流水癸亥', '天河水癸亥', '大溪水癸亥', '大海水癸亥', '霹雳火乙巳', '山下火乙巳', '覆灯火乙巳', '炉中火乙巳', '山头火乙巳', '天上火乙巳', '壁上土丁亥', '大驿土丁亥', '沙中土丁亥', '路旁土丁亥', '城头土丁亥', '屋上土丁亥']	  
	  };	
	  
	  // 年日地支查地支
	  var shenShaYearDayZhiZhi = {
	    '<span id="六厄">六厄</span>' : ['子卯', '丑子', '寅酉', '卯午', '辰卯', '巳子', '午酉', '未午', '申卯', '酉子', '戌酉', '亥午'], 
	    '<span id="孤辰">孤辰</span>' : ['子寅', '丑寅', '寅巳', '卯巳', '辰巳', '巳申', '午申', '未申', '申亥', '酉亥', '戌亥', '亥寅'], 
	    '<span id="寡宿">寡宿</span>' : ['子戌', '丑戌', '寅丑', '卯丑', '辰丑', '巳辰', '午辰', '未辰', '申未', '酉未', '戌未', '亥戌'], 
	    '<span id="咸池">咸池</span>' : ['子酉', '丑午', '寅卯', '卯子', '辰酉', '巳午', '午卯', '未子', '申酉', '酉午', '戌卯', '亥子'],       
	    '<span id="亡神">亡神</span>' : ['子亥', '丑申', '寅巳', '卯寅', '辰亥', '巳申', '午巳', '未寅', '申亥', '酉申', '戌巳', '亥寅'],      
	    '<span id="劫煞">劫煞</span>' : ['子巳', '丑寅', '寅亥', '卯申', '辰巳', '巳寅', '午亥', '未申', '申巳', '酉寅', '戌亥', '亥申'],       
	    '<span id="灾煞">灾煞</span>' : ['子午', '丑卯', '寅子', '卯酉', '辰午', '巳卯', '午子', '未酉', '申午', '酉卯', '戌子', '亥酉'],       
	    '<span id="驿马">驿马</span>' : ['子寅', '丑亥', '寅申', '卯巳', '辰寅', '巳亥', '午申', '未巳', '申寅', '酉亥', '戌申', '亥巳'],
	    '<span id="华盖">华盖</span>' : ['子辰', '丑丑', '寅戌', '卯未', '辰辰', '巳丑', '午戌', '未未', '申辰', '酉丑', '戌戌', '亥未'],
	    '<span id="墓杀">墓杀</span>' : ['子辰', '丑丑', '寅戌', '卯未', '辰辰', '巳丑', '午戌', '未未', '申辰', '酉丑', '戌戌', '亥未'],	  
	    '<span id="将星">将星</span>' : ['子子', '丑酉', '寅午', '卯卯', '辰子', '巳酉', '午午', '未卯', '申子', '酉酉', '戌午', '亥卯'],
	    '<span id="天罗">天罗</span>' : ['戌亥', '亥戌'],
	    '<span id="地网">地网</span>' : ['辰巳', '巳辰'],
	    //'<span id="吟呻">吟呻</span>' : ['子巳', '午巳', '卯巳', '酉巳'],
	    '<span id="破碎">破碎</span>' : ['寅酉', '申酉', '巳酉', '亥酉'],
	    //'<span id="白衣">白衣</span>' : ['辰丑', '戌丑', '丑丑', '未丑']	  
	  };
	  
	  //天罗地网(年柱纳音查地支)
	  var shenShaYearNaYinYearDiZhi = {     
	    '<span id="天罗纳音">天罗</span>' : ['霹雳火戌', '山下火戌', '覆灯火戌', '炉中火戌', '山头火戌', '天上火戌', '霹雳火亥', '山下火亥', '覆灯火亥', '炉中火亥', '山头火亥', '天上火亥'],
	    '<span id="地网纳音">地网</span>' : ['涧下水辰', '泉中水辰', '长流水辰', '天河水辰', '大溪水辰', '大海水辰', '涧下水巳', '泉中水巳', '长流水巳', '天河水巳', '大溪水巳', '大海水巳', '壁上土辰', '大驿土辰', '沙中土辰', '路旁土辰', '城头土辰', '屋上土辰', '壁上土巳', '大驿土巳', '沙中土巳', '路旁土巳', '城头土巳', '屋上土巳']
	  };
	  
	  //年日纳音查纳音
	  var shenShaYearNaYinDayNaYin = {     
	    '<span id="四大空">四大空</span>' : ['海中金涧下水', '海中金泉中水', '海中金长流水', '海中金天河水', '海中金大溪水', '海中金大海水', '炉中火涧下水', '炉中火泉中水', '炉中火长流水', '炉中火天河水', '炉中火大溪水', '炉中火大海水', '大林木涧下水', '大林木泉中水', '大林木长流水', '大林木天河水', '大林木大溪水', '大林木大海水', '路旁土涧下水', '路旁土泉中水', '路旁土长流水', '路旁土天河水', '路旁土大溪水', '路旁土大海水', '剑锋金涧下水', '剑锋金泉中水', '剑锋金长流水', '剑锋金天河水', '剑锋金大溪水', '剑锋金大海水', '沙中金涧下水', '沙中金泉中水', '沙中金长流水', '沙中金天河水', '沙中金大溪水', '沙中金大海水', '山下火涧下水', '山下火泉中水', '山下火长流水', '山下火天河水', '山下火大溪水', '山下火大海水', '平地木涧下水', '平地木泉中水', '平地木长流水', '平地木天河水', '平地木大溪水', '平地木大海水', '壁上土涧下水', '壁上土泉中水', '壁上土长流水', '壁上土天河水', '壁上土大溪水', '壁上土大海水', '金箔金涧下水', '金箔金泉中水', '金箔金长流水', '金箔金天河水', '金箔金大溪水', '金箔金大海水', '泉中水海中金', '泉中水剑锋金', '泉中水白蜡金', '泉中水沙中金', '泉中水金箔金', '泉中水钗钏金', '屋上土海中金', '屋上土剑锋金', '屋上土白蜡金', '屋上土沙中金', '屋上土金箔金', '屋上土钗钏金', '霹雳火海中金', '霹雳火剑锋金', '霹雳火白蜡金', '霹雳火沙中金', '霹雳火金箔金', '霹雳火钗钏金', '松柏木海中金', '松柏木剑锋金', '松柏木白蜡金', '松柏木沙中金', '松柏木金箔金', '松柏木钗钏金', '长流水海中金', '长流水剑锋金', '长流水白蜡金', '长流水沙中金', '长流水金箔金', '长流水钗钏金', '大溪水海中金', '大溪水剑锋金', '大溪水白蜡金', '大溪水沙中金', '大溪水金箔金', '大溪水钗钏金', '沙中土海中金', '沙中土剑锋金', '沙中土白蜡金', '沙中土沙中金', '沙中土金箔金', '沙中土钗钏金', '天上火海中金', '天上火剑锋金', '天上火白蜡金', '天上火沙中金', '天上火金箔金', '天上火钗钏金', '石榴木海中金', '石榴木剑锋金', '石榴木白蜡金', '石榴木沙中金', '石榴木金箔金', '石榴木钗钏金', '大海水海中金', '大海水剑锋金', '大海水白蜡金', '大海水沙中金', '大海水金箔金', '大海水钗钏金']
	  };
	  
	  // 年支查大运流年地支
	  var shenShaYearZhidaYunliuNianZhi = {
	    '<span id="丧门">丧门</span>' : ['子寅', '丑卯', '寅辰', '卯巳', '辰午', '巳未', '午申', '未酉', '申戌', '酉亥', '戌子', '亥丑'],
	    '<span id="吊客">吊客</span>' : ['子戌', '丑亥', '寅子', '卯丑', '辰寅', '巳卯', '午辰', '未巳', '申午', '酉未', '戌申', '亥酉']
	  };
	  
	  // 年日地支查大运流年地支
	  var shenShaYearZhiDayZhidaYunliuNianZhi = {
	    '<span id="披麻">披麻</span>' : ['子酉', '丑戌', '寅亥', '卯子', '辰丑', '巳寅', '午卯', '未辰', '申巳', '酉午', '戌未', '亥申']
	  };
	  
	  //年支查地支
	  var shenShaYearZhiDiZhi = {     
	    '<span id="红鸾">红鸾</span>' : ['子卯', '丑寅', '寅丑', '卯子', '辰亥', '巳戌', '午酉', '未申', '申未', '酉午', '戌巳', '亥辰'],  
	    '<span id="天喜">天喜</span>' : ['子酉', '丑申', '寅未', '卯午', '辰巳', '巳辰', '午卯', '未寅', '申丑', '酉子', '戌亥', '亥戌'],
	    '<span id="自缢煞">自缢煞</span>' : ['子酉', '丑午', '寅未', '卯申', '辰亥', '巳戌', '午丑', '未寅', '申卯', '酉子', '戌巳', '亥辰'],	  
	    '<span id="埋儿杀">埋儿杀</span>' : ['子丑', '丑卯', '寅申', '卯丑', '辰卯', '巳申', '午丑', '未卯', '申申', '酉丑', '戌卯', '亥申'],
	    //'<span id="兼刃">兼刃</span>' : ['寅戌', '卯亥', '申辰', '酉巳'],
	    '<span id="病符">病符</span>' : ['子亥', '丑子', '寅丑', '卯寅', '辰卯', '巳辰', '午巳', '未午', '申未', '酉申', '戌酉', '亥戌'],	  
	    '<span id="吞陷煞">吞陷煞</span>' : ['子戌', '丑丑', '丑寅', '卯巳', '卯戌', '辰辰', '巳申', '午寅', '未寅', '申巳', '申戌', '酉戌', '戌寅', '戌酉', '亥寅'],
	    '<span id="攀鞍">攀鞍</span>' : ['子丑', '丑戌', '寅未', '卯辰', '辰丑', '巳戌', '午未', '未辰', '申丑', '酉戌', '戌未', '亥辰'],
	    '<span id="大耗">大耗</span>' : ['子巳', '丑午', '寅未', '卯申', '辰酉', '巳戌', '午亥', '未子', '申丑', '酉寅', '戌卯', '亥辰'],	  
	    '<span id="小耗">小耗</span>' : ['子午', '丑未', '寅申', '卯酉', '辰戌', '巳亥', '午子', '未丑', '申寅', '酉卯', '戌辰', '亥巳']	  
	  };
	  
	  //年支查干支
	  var shenShaYearZhiGanZhi = {
	    //'<span id="年兼刃">兼刃</span>' : ['子壬申', '丑癸酉', '辰壬子', '巳癸丑', '午丙寅', '未己卯', '未丁卯', '戌丙午', '亥己未', '亥丁未']
	  };	
	  
	  // 月支查天干或地支
	  var shenShaMonthZhiGanZhi = {    
	    '<span id="天德">天德</span>' : ['寅丁', '卯申', '辰壬', '巳辛', '午亥', '未甲', '申癸', '酉寅', '戌丙', '亥乙', '子巳', '丑庚'],
	    '<span id="天德合">天德合</span>' : ['寅壬', '卯巳', '辰丁', '巳丙', '午寅', '未己', '申戊', '酉亥', '戌辛', '亥庚', '子申', '丑乙'],
	    '<span id="月德">月德</span>' : ['寅丙', '卯甲', '辰壬', '巳庚', '午丙', '未甲', '申壬', '酉庚', '戌丙', '亥甲', '子壬', '丑庚'],
	    '<span id="月德合">月德合</span>' : ['寅辛', '卯巳', '辰丁', '巳乙', '午辛', '未己', '申丁', '酉乙', '戌辛', '亥己', '子丁', '丑乙'],	  
	    '<span id="德秀"><u>德</u>秀</span>' : ['寅丙', '寅丁', '卯甲', '卯乙', '辰壬', '辰癸', '辰戊', '辰己', '巳庚', '巳辛', '午丙', '午丁', '未甲', '未乙', '申壬', '申癸', '申戊', '申己', '酉庚', '酉辛', '戌丙', '戌丁', '亥甲', '亥乙', '子壬', '子癸', '子戊', '子己', '丑庚', '丑辛'],
	    '<span id="秀德">德<u>秀</u></span>' : ['寅戊', '寅癸', '卯丁', '卯壬', '辰丙', '辰辛', '辰甲', '辰己', '巳乙', '巳庚', '午戊', '午癸', '未丁', '未壬', '申丙', '申辛', '申甲', '申己', '戌戊', '戌癸', '亥丁', '亥壬', '子丙', '子辛', '子甲', '子己', '丑乙', '丑庚'],
	    //'<span id="注受">注受</span>' : ['寅子', '卯亥', '辰戌', '巳酉', '午戌', '未亥', '申子', '酉丑', '戌寅', '亥卯', '子寅', '丑丑'],
	    '<span id="五鬼">五鬼</span>' : ['寅午', '卯未', '辰申', '巳酉', '午戌', '未亥', '申子', '酉丑', '戌寅', '亥卯', '子辰', '丑巳'],
	    '<span id="月破">月破</span>' : ['寅申', '卯酉', '辰戌', '巳亥', '午子', '未丑', '申寅', '酉卯', '戌辰', '亥巳', '子午', '丑未'],	  
	    '<span id="天医">天医</span>' : ['寅丑', '卯寅', '辰卯', '巳辰', '午巳', '未午', '申未', '酉申', '戌酉', '亥戌', '子亥', '丑子'],
	    //'<span id="戟锋煞">戟锋煞</span>' : ['寅甲', '卯乙', '辰戊', '巳丙', '午丁', '未己', '申庚', '酉辛', '戌戊', '亥壬', '子癸', '丑巳']		  
	  };
	   
	   //月支查日干支
	  var shenShaMonthZhiDayGanZhi = {    
	    '<span id="四废日">四废日</span>' : ['寅庚申', '卯庚申', '辰庚申', '寅辛酉', '卯辛酉', '辰辛酉', '巳壬子', '午壬子', '未壬子', '巳癸亥', '午癸亥', '未癸亥', '申甲寅', '酉甲寅', '戌甲寅', '申乙卯', '酉乙卯', '戌乙卯', '亥丙午', '子丙午', '丑丙午', '亥丁巳', '子丁巳', '丑丁巳'],
	    '<span id="天赦日">天赦日</span>' : ['寅戊寅', '卯戊寅', '辰戊寅', '巳甲午', '午甲午', '未甲午', '申戊申', '酉戊申', '戌戊申', '亥甲子', '子甲子', '丑甲子']
	  };
	     
	  //查日时干支    
	  var shenShaDayTimeGanZhi = {    
	     '<span id="孤鸾">孤鸾</span>' : ['乙巳', '丁巳', '辛亥', '戊申', '甲寅', '戊午', '丙午', '壬子'],
	     '<span id="金神">金神</span>' : ['乙丑', '己巳', '癸酉']       
	  };
	  
	   //只查日干支
	  var shenShaDayDayGanZhi = {    
	     '<span id="差错">差错</span>' : ['丙子', '丁丑', '戊寅', '辛卯', '壬辰', '癸巳', '丙午', '丁未', '戊申', '辛酉', '壬戌', '癸亥'],
	     '<span id="大败">大败</span>' : ['甲辰', '乙巳', '丙申', '丁亥', '戊戌', '己丑', '庚辰', '辛巳', '壬申', '癸亥'],
	     '<span id="六秀日">六秀日</span>' : ['丙午', '丁未', '戊子', '戊午', '己丑', '己未'],
	     '<span id="日德">日德</span>' : ['甲寅', '丙辰', '戊辰', '庚辰', '壬戌'],
	     '<span id="日贵">日贵</span>' : ['丁酉', '丁亥', '癸卯', '癸巳'],
	     '<span id="进神">进神</span>' : ['甲子', '甲午', '乙卯', '乙酉'],
	     '<span id="退神">退神</span>' : ['丁丑', '丁未', '壬辰', '壬戌'],
	     '<span id="魁罡">魁罡</span>' : ['壬辰', '庚辰', '庚戌', '戊戌'],
	     '<span id="阴阳煞">阴阳煞</span>' : ['丙子', '戊午'],
	     '<span id="八专">八专</span>' : ['甲寅', '乙卯', '戊戌', '己未', '丁未', '庚申', '辛酉', '癸丑'],
	     '<span id="九丑">九丑</span>' : ['戊子', '戊午', '壬子', '壬午', '乙卯', '己卯', '辛卯', '己酉', '辛卯']
	  };
	  
	  //日干查地支    
	  var shenShaDayGanDiZhi = {
	    '<span id="羊刃">羊刃</span>' : ['甲卯', '乙寅', '丙午', '丁巳', '戊午', '己巳', '庚酉', '辛申', '壬子', '癸亥'],
	    '<span id="飞刃">飞刃</span>' : ['甲酉', '乙申', '丙子', '丁亥', '戊子', '己亥', '庚卯', '辛寅', '壬午', '癸巳'],
	    '<span id="红艳">红艳</span>' : ['甲午', '乙申', '丙寅', '丁未', '戊辰', '己辰', '庚戌', '辛酉', '壬子', '癸申'],
	    '<span id="流霞">流霞</span>' : ['甲酉', '乙戌', '丙未', '丁申', '戊巳', '己午', '庚辰', '辛卯', '壬亥', '癸寅'],
	    //'<span id="沐浴">沐浴</span>' : ['甲子', '乙巳', '丙卯', '丁申', '戊卯', '己申', '庚午', '辛亥', '壬酉', '癸寅'],
	    '<span id="墓库">墓库</span>' : ['甲未', '乙戌', '丙戌', '丁丑', '戊戌', '己丑', '庚丑', '辛辰', '壬辰', '癸未'],
	    '<span id="禄神">禄神</span>' : ['甲寅', '乙卯', '丙巳', '丁午', '戊巳', '己午', '庚申', '辛酉', '壬亥', '癸子'],
	    '<span id="水溺煞">水溺煞</span>' : ['丙子', '癸未', '癸丑']
	  };     
	  
	  //日干查时支    
	  var shenShaDayGanTimeZhi = {
	    '<span id="截路">截路</span>' : ['甲申', '甲酉', '乙申', '乙酉', '丙辰', '丙巳', '辛辰', '辛巳', '丁寅', '丁卯', '壬寅', '壬卯', '戊子', '戊丑', '癸子', '癸丑']
	   }; 
	   
	  //日支查地支    
	  var shenShaDayZhiDiZhi = { 
	    '<span id="日破">日破</span>' : ['子午', '丑未', '寅申', '卯酉', '辰戌', '巳亥', '午子', '未丑', '申寅', '酉卯', '戌辰', '亥巳']  
	  }; 
	  
	  //日支查时支    
	  var shenShaDayZhiTimeZhi = { 
	    '<span id="隔角煞">隔角煞</span>' : ['子寅', '丑卯', '寅辰', '卯巳', '辰午', '巳未', '午申', '未酉', '申戌', '酉亥', '戌子', '亥丑']	  
	  }; 
	  
	  //查日柱时柱
	  var shenShaDayGanZhiTimeGanZhi = { 
	    '<span id="拱子禄">拱子禄</span>' : ['癸亥癸丑', '癸丑癸亥'],
	    '<span id="拱午禄">拱午禄</span>' : ['丁巳丁未', '己未己巳'],	  
	    '<span id="拱巳禄">拱巳禄</span>' : ['戊辰戊午']	  
	  }; 
	  
	  //童子(月支查日支时支)
	  var shenShaMonthZhiDayZhiTimeZhi = {     
	    '<span id="童子">童子</span>' : ['寅寅', '卯寅', '辰寅', '申寅', '酉寅', '戌寅', '寅子', '卯子', '辰子', '申子', '酉子', '戌子', '巳卯', '午卯', '未卯', '亥卯', '子卯', '丑卯', '巳未', '午未', '未未', '亥未', '子未', '丑未', '巳辰', '午辰', '未辰', '亥辰', '子辰', '丑辰']
	  };     
	  //童子(年柱纳音查日支和时支)
	  var shenShaYearNaYinDayZhiTimeZhi = {     
	    '<span id="童子纳音">童子</span>' : ['海中金午', '剑锋金午', '白蜡金午', '沙中金午', '金箔金午', '钗钏金午', '大林木午', '杨柳木午', '松柏木午', '平地木午', '桑柘木午', '石榴木午', '海中金卯', '剑锋金卯', '白蜡金卯', '沙中金卯', '金箔金卯', '钗钏金卯', '大林木卯', '杨柳木卯', '松柏木卯', '平地木卯', '桑柘木卯', '石榴木卯', '涧下水戌', '泉中水戌', '长流水戌', '天河水戌', '大溪水戌', '大海水戌', '涧下水酉', '泉中水酉', '长流水酉', '天河水酉', '大溪水酉', '大海水酉', '霹雳火戌', '山下火戌', '覆灯火戌', '炉中火戌', '山头火戌', '天上火戌', '霹雳火酉', '山下火酉', '覆灯火酉', '炉中火酉', '山头火酉', '天上火酉', '壁上土辰', '大驿土辰', '沙中土辰', '路旁土辰', '城头土辰', '屋上土辰', '壁上土巳', '大驿土巳', '沙中土巳', '路旁土巳', '城头土巳', '屋上土巳']
	  };
	  
	  // 年支查地支，男女分别看（阳男阴女）
	  var shenShaYearZhiZhiYangNanYinNv = {     
	    '<span id="勾煞男">勾煞</span>' : ['子卯', '丑辰', '寅巳', '卯午', '辰未', '巳申', '午酉', '未戌', '申亥', '酉子', '戌丑', '亥寅'],
	    '<span id="绞煞男">绞煞</span>' : ['子酉', '丑戌', '寅亥', '卯子', '辰丑', '巳寅', '午卯', '未辰', '申巳', '酉午', '戌未', '亥申'],
	    '<span id="元辰男">元辰</span>' : ['子未', '丑申', '寅酉', '卯戌', '辰亥', '巳子', '午丑', '未寅', '申卯', '酉辰', '戌巳', '亥午']
	  };
	  
	  // 年支查地支，男女分别看（阴男阳女）    
	  var shenShaYearZhiZhiYinNanYangNv = {      
	    '<span id="勾煞女">勾煞</span>' : ['子酉', '丑戌', '寅亥', '卯子', '辰丑', '巳寅', '午卯', '未辰', '申巳', '酉午', '戌未', '亥申'],  
	    '<span id="绞煞女">绞煞</span>' : ['子卯', '丑辰', '寅巳', '卯午', '辰未', '巳申', '午酉', '未戌', '申亥', '酉子', '戌丑', '亥寅'],  
	    '<span id="元辰女">元辰</span>' : ['子巳', '丑午', '寅未', '卯申', '辰酉', '巳戌', '午亥', '未子', '申丑', '酉寅', '戌卯', '亥辰']    
	  };
...
$('#shensha').html(''+
/*	'<table style="border-top:0px;"><tr>'+
    '<th class="th1" valign="top">神煞</th>'+
    '<td colspan="2" valign="top" class="td1" style="width:21.13%">'+ (shenShaYear.length<1 ? '无' : shenShaYear.join('<br>')) + '</td>'+
    '<td colspan="2" valign="top" class="td1" style="width:21.13%">'+ (shenShaMonth.length<1 ? '无' : shenShaMonth.join('<br>')) +'</td>'+
    '<td colspan="2" valign="top" class="td1" style="width:21.13%">'+ (shenShaDay.length<1 ? '无' : shenShaDay.join('<br>')) +'</td>'+	
    '<td colspan="2" valign="top" class="td1" style="width:21.13%">'+ (shenShaTime.length<1 ? '无' : shenShaTime.join('<br>')) +'</td>'+		
    '</tr>'+
	'</table>'); //神煞
	*/
   
	'<table style="border-top:0px;">'+
    '<tr><th class="th1" style="width:100%" colspan="9">四柱神煞</th></td></tr>'+
    '<tr><th class="th2" style="width:15%">' + bazi.getYear() + '</th><td colspan="8" class="td2" style="text-align:left;">'+ (shenShaYear.length<1 ? '无' : shenShaYear.join(' ')) + '</td></tr>'+
    '<tr><th class="th1" style="">' + bazi.getMonth() + '</th><td colspan="8" class="td1" style="text-align:left;">'+ (shenShaMonth.length<1 ? '无' : shenShaMonth.join(' ')) +'</td></tr>'+
    '<tr><th class="th2" style="">' + bazi.getDay() + '</th><td colspan="8" class="td2" style="text-align:left;">'+ (shenShaDay.length<1 ? '无' : shenShaDay.join(' ')) +'</td></tr>'+	
    '<tr><th class="th1" style="">' + bazi.getTime() + '</th><td colspan="8" class="td1" style="text-align:left;">'+ (shenShaTime.length<1 ? '无' : shenShaTime.join(' ')) +'</td></tr>'+		
    ''+
	'</table>'); //神煞	
...
// 太岁
    ...
    $('#fantaisui').html(''+(matched.length<1 ? '未犯太岁' : matched.join(' '))+''); //犯太岁
 ...
 //婚配
  ...
  $('#text666').html('【'+bazi.getDay()+'论命】<jiazilm'+bazi.getDay()+'>');
...
$('#text222').val(txt123);	
      ...
      tds.eq(24).html('小<br>运');
      for(var i=0,j=daYun.length;i<j;i++){
        var d = daYun[i];
		  var dds =LunarUtil.SHI_SHEN_GAN[bazi.getDayGan() + d.getGanZhi().substr(0,1)];
			  if(d.getGanZhi()==''){dds='';}
        //tds.eq(1+i).html('');
        tds.eq(1+i).html('<span style=font-size:13px>'+d.getStartYear()+'</span><br><span style=font-size:14.1px>'+d.getStartAge()+'岁</span><br>'+d.getGanZhi()+'<br><font color=red>'+dds+'</font><br>'+changsheng(bazi.getDay().substr(0,1)+d.getGanZhi().substr(-1))+'<!--br>'+tiandiwuxing(d.getGanZhi().substr(0,1))+'<br>'+tiandiwuxing(d.getGanZhi().substr(-1))+'<br-->');
...
shishentext2+=shishen2(liunianshishen+dayunshishen);
        ...
        //tds.eq(14+i).html('');
        tds.eq(13+i).html('<span style=font-size:13px>'+d.getYear()+'</span><br><span style=font-size:14.1px>'+d.getAge()+'岁</span><br>'+d.getGanZhi()+'<br><font color=red>'+liunianshishen+'</font><br>'+changsheng(bazi.getDay().substr(0,1)+d.getGanZhi().substr(-1))+'<br><!--br>'+tiandiwuxing(d.getGanZhi().substr(0,1))+'<br>'+tiandiwuxing(d.getGanZhi().substr(-1))+'<br><a title="'+shishentext+'" onclick=alert("'+shishentext+'")>参1</a>'+'<br><a title="'+shishentext2+'" onclick=alert("'+shishentext2+'")>考2</a-->');
      ...
      for(var i=0,j=xiaoYun.length;i<j;i++){
        var d = xiaoYun[i];
        tds.eq(25+i).html(''+d.getGanZhi()+'<br><font color=red>'+LunarUtil.SHI_SHEN_GAN[bazi.getDayGan() + d.getGanZhi().substr(0,1)]+'</font><br><!--br>'+tiandiwuxing(d.getGanZhi().substr(0,1))+'<br>'+tiandiwuxing(d.getGanZhi().substr(-1))+'<br-->'+changsheng(bazi.getDay().substr(0,1)+d.getGanZhi().substr(-1))+'');
      }
      ...
      try{
        ...
        for(var i=0,j=liuYue.length;i<j;i++){
          var d = liuYue[i];
          tds.eq(1+i).html(d.getMonthInChinese()+'月'+'<br>');
			/*d.getliuyun2()实现流月也能预测好坏了。哈哈，当然是在lunar-xiugai.js中添加函数getliuyun2，并添加了 liuyue2数组*/
          tds.eq(13+i).html(''+d.getGanZhi()+'<br><font color=red>'+LunarUtil.SHI_SHEN_GAN[bazi.getDayGan() + d.getGanZhi().substr(0,1)]+'</font><!--br>'+tiandiwuxing(d.getGanZhi().substr(0,1))+'<br>'+tiandiwuxing(d.getGanZhi().substr(-1))+'<br--><br>'+changsheng(bazi.getDay().substr(0,1)+d.getGanZhi().substr(-1)));
        }
      }catch(ex){
        console.log(ex);
        if(INDEX.daYun==0){
